...
// 		if(response.indexOf("Email and password field is required") || response.indexOf ("Enter a valid email adddress") || response.indexOf("Failed to send your message"))   
